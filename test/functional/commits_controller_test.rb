...
class CommitsControllerTest < ActionController::TestCase
  ...
  test "should create commit" do
    assert_difference('Commit.count') do
      post :create, commit: { date: @commit.date, message: @commit.message, sha: @commit.sha, tree: @commit.tree, url: @commit.url }
    end
  ...
  test "should update commit" do
    put :update, id: @commit, commit: { date: @commit.date, message: @commit.message, sha: @commit.sha, tree: @commit.tree, url: @commit.url }
    assert_redirected_to commit_path(assigns(:commit))
  end
